...
export class ProjetsManagementService {
  ...
  deleteById(modelId,formData): Observable<HttpResponse<any>> {
    return this.http.post(`${this.url}/${modelId}/delete`,formData, {observe: 'response'});
  }
  ...
  getAllProjets({ limit_per_page, page }, body): Observable<HttpResponse<any>> {
